...
use App\Http\Requests\CategoriesRequest as MasterRequest;
use App\Category as MasterModel;
use App\ViewCategory as MasterViewModel;
use Sentinel;
use Redirect;
...
class CategoriesController extends Controller
{
    public function __construct() {
        $this->middleware('permissionsCategory');
