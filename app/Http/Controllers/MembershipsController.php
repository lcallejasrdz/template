...
use App\Http\Requests\MembershipsRequest as MasterRequest;
use App\Membership as MasterModel;
use App\ViewMembership as MasterViewModel;
use Sentinel;
use Redirect;
...
class MembershipsController extends Controller
{
    public function __construct() {
        $this->middleware('permissionsMembership');
        
        $this->active = "memberships";
