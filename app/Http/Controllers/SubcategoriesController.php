...
use App\Http\Requests\SubcategoriesRequest as MasterRequest;
use App\Subcategory as MasterModel;
use App\ViewSubcategory as MasterViewModel;
use Sentinel;
use Redirect;
...
class SubcategoriesController extends Controller
{
    public function __construct() {
        $this->middleware('permissionsSubcategory');
        
        $this->active = "subcategories";
    ...
    public function create()
    {
        ...
        return view('admin.create', compact($this->compact, 'catalog_category_id'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.edit', compact($this->compact, 'item', 'catalog_category_id'));
    }
