                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    <tr>
                                        <th>
                                            {{ trans('validation.attributes.ubication') }}
                                        </th>
                                        <td>
                                            {{ $item->address }}
                                            <br><br>
                                            {!! Form::hidden('searchmap', old('searchmap', $item->address), ['id' => 'searchmap']) !!}
                                            <div id='map' style="min-width: 550px; width: 100%; height: 350px;"></div>
                                            {!! Form::hidden('lat', old('lat', $item->lat), ['id'=>'lat']) !!}
                                            {!! Form::hidden('lng', old('lng', $item->lng), ['id'=>'lng']) !!}
                                            {!! Form::hidden('address', old('address', $item->address), ['id'=>'address']) !!}
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        <th>
                                            {{ trans('validation.attributes.max_buy') }}
                                        </th>
                                        <td>
                                            {{ $item->max_buy }}
                                        </td>
                                    ...
                                    <tr>
                                        <th>
                                            {{ trans('validation.attributes.duration') }}
                                        </th>
                                        <td>
                                            {{ $item->duration }} {{ trans('validation.attributes.hrs') }}
                                        </td>
                                    </tr>
                                </table>
                            </div>
