<div class="tab-pane" id="tab1">
    <h2 class="hidden">&nbsp;</h2>
    {!! Form::hidden('product_module_id', 2) !!}
...
<div class="tab-pane" id="tab4">
    <h2 class="hidden">&nbsp;</h2>
    <div class="form-group {{ $errors->first('ubication') ? 'has-error' : '' }}">
        {!! Form::label('ubication', trans('validation.attributes.ubication').' *', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            <div class="radio-inline">
                <label>
                    @if(isset($item))
                        {!! Form::radio('ubication', 0, $item->address != '' ? false : true) !!}
                    @else
                        {!! Form::radio('ubication', 0, true) !!}
                    @endif
                    No
                </label>
            </div>
            <div class="radio-inline">
                <label>
                    @if(isset($item))
                        {!! Form::radio('ubication', 1, $item->address != '' ? true : false) !!}
                    @else
                        {!! Form::radio('ubication', 1, false) !!}
                    @endif
                    Si
                </label>
            </div>
            <span class="help-block">{{ $errors->first('ubication', ':message') }}</span>
        </div>
    </div>

    <div class="form-group {{ $errors->first('searchmap') ? 'has-error' : '' }}">
        {!! Form::label('searchmap', trans('validation.attributes.searchmap').' *', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            @if(isset($item))
                {!! Form::text('searchmap', old('searchmap', $item->address), ['id' => 'searchmap', 'class' => 'form-control', 'placeholder' => trans('validation.attributes.searchmap')]) !!}
            @else
                {!! Form::text('searchmap', old('searchmap'), ['id' => 'searchmap', 'class' => 'form-control', 'placeholder' => trans('validation.attributes.searchmap')]) !!}
            @endif
            <span class="help-block">{{ $errors->first('searchmap', ':message') }}</span>
        </div>
        <div class="col-sm-10 col-sm-offset-2">
            <div id='map' style="height: 350px;"></div>
            {!! Form::hidden('lat', old('lat'), ['id'=>'lat']) !!}
            {!! Form::hidden('lng', old('lng'), ['id'=>'lng']) !!}
            {!! Form::hidden('address', old('address'), ['id'=>'address']) !!}
        </div>
    </div>
</div>
...
<div class="tab-pane" id="tab5">
    ...
    <div class="form-group {{ $errors->first('max_buy') ? 'has-error' : '' }}">
        {!! Form::label('max_buy', trans('validation.attributes.max_buy').' *', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::text('max_buy', old('max_buy'), ['id' => 'max_buy', 'class' => 'form-control', 'placeholder' => trans('validation.attributes.max_buy')]) !!}
            <span class="help-block">{{ $errors->first('max_buy', ':message') }}</span>
        </div>
    </div>

    <div class="form-group {{ $errors->first('capacity') ? 'has-error' : '' }}">
        {!! Form::label('capacity', trans('validation.attributes.capacity').' *', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::text('capacity', old('capacity'), ['id' => 'capacity', 'class' => 'form-control', 'placeholder' => trans('validation.attributes.capacity')]) !!}
            <span class="help-block">{{ $errors->first('capacity', ':message') }}</span>
        </div>
    </div>
    ...
    <div class="form-group {{ $errors->first('duration') ? 'has-error' : '' }}">
        {!! Form::label('duration', trans('validation.attributes.duration').' *', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::text('duration', old('duration'), ['id' => 'duration', 'class' => 'form-control', 'placeholder' => trans('validation.attributes.duration')]) !!}
